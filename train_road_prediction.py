...
Anchor_train = X_road_train[2000:4000]
X_road_train = X_road_train[:2000]
Y_non_road_train = Y_non_road_train[:2000]
...
anchor = make_logits(anchor_image)
positive = make_logits(positive_image)
negative = make_logits(negative_image)
...
with tf.Session() as sess:
    ...
    for epoch in range(epochs):
        ...
        for batch_X_road, batch_Y_non_road in batch_features_labels(X_road_train, Y_non_road_train, batch_size):
